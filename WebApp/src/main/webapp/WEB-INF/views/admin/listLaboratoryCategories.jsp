...
<div class="container">
    ...
    <c:forEach items="${formLaboratoryShowDto.sections}" var="section">
        <h2>Section: ${section.name}</h2>
        <c:forEach items="${formLaboratoryShowDto.years}" var="year">
            <h4>
                <c:forEach items="${formLaboratoryShowDto.semesters}" var="semester">
