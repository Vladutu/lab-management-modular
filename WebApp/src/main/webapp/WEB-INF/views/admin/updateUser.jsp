...
<div class="generic-container">
    <div class="panel panel-default">
        <div class="panel-heading"><span class="lead">Update User</span></div>
            ...
            <form:form method="POST" modelAttribute="userDto" role="form">
                ...
                <spring:bind path="password">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        ...
                        <button type="button" class="btn btn-info" id="passButton" onclick="onPasswordButtonClick()">
                            Change
                            password
                        </button>
                ...
                <spring:bind path="userState">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        ...
                        <form:select path="userState" items="${formUserDto.states}" multiple="false"
                                     class="form-control"
                                     id="userState"/>
