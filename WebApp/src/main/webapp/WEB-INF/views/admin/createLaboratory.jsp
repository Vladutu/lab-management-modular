...
<div class="generic-container">
    <div class="panel panel-default">
        <div class="panel-heading"><span class="lead">Create New Laboratory</span></div>
            ...
            <form:form method="POST" modelAttribute="laboratoryDto" role="form">
                ...
                <spring:bind path="from">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        ...
                        <form:select path="from" items="${formLaboratoryCreateDto.hours}" multiple="false"
                                     class="form-control"
                                     id="userType"/>
                ...
                <spring:bind path="to">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        ...
                        <form:select path="to" items="${formLaboratoryCreateDto.hours}" multiple="false"
                                     class="form-control"
                                     id="to"/>
                ...
                <spring:bind path="day">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        ...
                        <form:select path="day" items="${formLaboratoryCreateDto.days}" multiple="false"
                                     class="form-control"
                                     id="day"/>
                ...
                <spring:bind path="room">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        ...
                        <form:select path="room" items="${formLaboratoryCreateDto.rooms}" multiple="false"
                                     class="form-control"
                                     id="room"/>
                ...
                <spring:bind path="formProfessorDto.compressedFields">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        ...
                        <form:select path="formProfessorDto.compressedFields"
                                     items="${formLaboratoryCreateDto.professors}"
